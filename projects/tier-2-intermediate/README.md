---
title: Tier 2 — Intermediate Projects
purpose: Full-pipeline, deployment-aware projects with real IB/FinTech domain framing — the bulk of the interview-ready portfolio.
owner: Arulkumaran
dependencies: [docs/engineering-standards/mlops.md]
related_documents: [projects/README.md]
version: 0.1.0
last_updated: 2026-07-02
---

## Overview
Tier 2 projects require a served API, at minimum, and explicit IB/FinTech domain framing (KYC/AML, MiFID II, credit risk, suitability). Several build directly on Tier 1 models.
