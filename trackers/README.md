---
title: trackers/ — Reusable Tracker Templates
purpose: The 14 tracker templates named in the original DSOS scope — daily, weekly, monthly, learning, coding, project, git, GitHub, reading, portfolio, interview, confidence, habit, and KPI dashboard.
owner: Arulkumaran
dependencies: [AGENTS.md]
related_documents: [docs/master-index.md, templates/README.md, docs/operating-system/README.md]
version: 0.1.0
...
- [Overview](#overview)
- [The 14 Trackers](#the-14-trackers)
- [Trackers vs. Templates](#trackers-vs-templates)
...
`templates/` (50 files, the v1.0 target) covers project blueprints, career artifacts, review formats, and engineering scaffolding. `trackers/` is specifically the recurring, tabular, filled-in-over-time formats named in the original scope's dedicated "Trackers" section — kept separate so the 50-template count stays clean and matches the original scope's own category boundary.
